...
- **TASK-113** `[P3]` `status:in-progress` — Create `IOSStateObservation` wrapping `PepperState.shared` + `PepperIdleMonitor.shared` + `PepperScreenRegistry`. *(blocked by TASK-110)*
