...
- **TASK-102** `[P3]` `status:in-progress` — Create `dylib/core/PepperGeometry.swift` with platform-agnostic `PepperPoint`/`PepperRect` (midX/midY, contains, intersects). Add `#if canImport(UIKit)` CGRect/CGPoint bridging extensions.
