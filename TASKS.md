...
- **TASK-070** `[P3]` `status:in-progress` — Extract `mcp_tools_debug.py`: tool definitions for layers, console, network, timeline, crash_log, animations, lifecycle, heap (~200 lines)
