...
- **TASK-068** `[P3]` `status:in-progress` — Extract `mcp_tools_nav.py`: tool definitions for look, tap, scroll, input, navigate, back, dismiss, swipe, screen, scroll_to, dismiss_keyboard (~200 lines)
