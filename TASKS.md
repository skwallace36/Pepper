...
- **TASK-110** `[P3]` `status:in-progress` — Create `IOSPlatform.swift` factory + add `platform` property to `PepperPlane.shared`. Wire it up in `start()`. *(blocked by TASK-100, TASK-101)*
