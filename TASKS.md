...
- **TASK-062** `[P3]` `status:in-progress` — Extract `pepper_format.py`: `format_look()` with optional ANSI color support. Deduplicate pepper-mcp (~150 lines) and pepper-ctl (~120 lines) formatting code
