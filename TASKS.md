...
- **TASK-025** `[P2]` `status:in-progress` — Add test app surfaces for blocked commands: URL scheme + deeplink routes, share button, rotation gesture view, UNNotification delegate, Localizable.strings, seed UserDefaults on launch, WKWebView with cookie, seed keychain entry
