...
- **TASK-029** `[P2]` `status:in-progress` — Run `heap`, `vars`, `layers`, `network` against Ice Cubes. These are the deep introspection commands — stress test them against a real app's object graph and network traffic.
