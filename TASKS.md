...
- **TASK-011** `[P2]` `status:unstarted` — Test `scroll` variants: top, bottom, up, left, right *(5 untested)*
- **TASK-012** `[P2]` `status:in-progress` — Test `scroll_to` variants: element, text, predicate, edge *(4 untested)*
