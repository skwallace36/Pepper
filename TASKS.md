...
- **TASK-027** `[P2]` `status:in-progress` — Clone Ice Cubes, build for simulator, inject Pepper, verify `look` works. Record what the element tree looks like for a real SwiftUI app (lazy lists, navigation stacks, tab bars, async images).
