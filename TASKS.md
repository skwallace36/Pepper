...
- **TASK-112** `[P3]` `status:in-progress` — Create `IOSInputSynthesis` wrapping `PepperHIDEventSynthesizer.shared` (tap, doubleTap, scroll, swipe, gesture, inputText, toggle). *(blocked by TASK-110)*
