...
- **TASK-071** `[P3]` `status:in-progress` — Extract `mcp_tools_system.py`: tool definitions for push, status, highlight, orientation, locale, gesture, hook, find, flags, dialog, toggle, read_element, tree (~300 lines)
