...
9. **Update labels (state machine transition):**
   ...
   ```
   gh pr edit <number> --repo skwallace36/Pepper-private --remove-label "awaiting:responder"
   gh pr edit <number> --repo skwallace36/Pepper-private --add-label "awaiting:verifier"
   ```
