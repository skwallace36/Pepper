...
3. Add `<!-- researched YYYY-MM-DD -->` to that row and commit: `git commit -m "claim research: <topic>"`
4. Investigate the idea:
...
5. Add your findings to RESEARCH.md under a new section `### <topic>` below the table.
   Format:
   ```
   ### <topic>
   ...
   **Risks:**
   ...
   ```
6. Commit and push.
7. Do NOT open a PR — research findings go directly to the branch for review.
